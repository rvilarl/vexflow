...
export class Stave extends Element {
  ...
  // Volta functions
  setVoltaType(type: number, numberT: string, y: number): this {
    this.modifiers.push(new Volta(type, numberT, this.x, y));
    return this;
  }
   ...
   * @throws RuntimeError "StaveConfigError" When the linesConfiguration array does not have
