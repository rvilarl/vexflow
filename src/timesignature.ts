...
export class TimeSignature extends StaveModifier {
  ...
  static getTimeSigCode(key: string, smallSig = false): number {
    let code = 0;
    switch (key) {
      case 'C':
        code = 0xe08a /*timeSigCommon*/;
        break;
      case 'C|':
        code = 0xe08b /*timeSigCutCommon*/;
        break;
      case '+':
        code = smallSig ? 0xe08d /*timeSigPlusSmall*/ : 0xe08c /*timeSigPlus*/;
        break;
      case '-':
        code = 0xe090 /*timeSigMinus*/;
        break;
      case '(':
        code = smallSig ? 0xe092 /*timeSigParensLeftSmall*/ : 0xe094 /*timeSigParensLeft*/;
        break;
      case ')':
        code = smallSig ? 0xe093 /*timeSigParensRightSmall*/ : 0xe095 /*timeSigParensRight*/;
        break;
      default:
        code = 0xe080 + key.charCodeAt(0) - '0'.charCodeAt(0) /*timeSigN*/;
        break;
    }
    return code;
  }
