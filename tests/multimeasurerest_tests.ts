...
function simple(options: TestOptions): void {
  ...
  const lineSpacing_15px = { options: { spacingBetweenLinesPx: 15 } };
  ...
  const params: [any, MultimeasureRestRenderOptions][] = [
    ...
    [lineSpacing_15px, { numberOfMeasures: 12 }],
    [lineSpacing_15px, { numberOfMeasures: 9, useSymbols: true }],
    [lineSpacing_15px, { numberOfMeasures: 12, spacingBetweenLinesPx: 15, numberGlyphPoint: 40 * 1.5 }],
    [
      lineSpacing_15px,
      {
        numberOfMeasures: 9,
